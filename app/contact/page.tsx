          ...
          <div className="lg:col-span-1 space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-sm sm:text-base">
                    ...
                    {language === "en" ? "9011702323" : "९०११७०२३२३"}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <div className="flex gap-4">
                <a
                  href="https://www.facebook.com/share/16RTE1GyQu/"
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 mt-8">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="w-full aspect-[3/2] bg-gray-200 relative overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1612.3387949503676!2d74.226781!3d16.976946!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc10a72485b5663%3A0xd5584a01efd989e6!2sJakraiwadi%2C%20Maharashtra%2C%20India!5e1!3m2!1sen!2sus!4v1760959079465!5m2!1sen!2sus"
                width="1200"
                height="800"
                loading="lazy"
              ></iframe>
