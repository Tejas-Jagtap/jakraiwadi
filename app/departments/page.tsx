  ...
  const subPages = [
    {
      ...
      description:
        language === "en"
          ? "Primary Health Subcenter"
          : "प्राथमिक आरोग्य उपकेंद्र",
      head: language === "en" ? "Dr. " : "डॉ.",
      phone: language === "en" ? "+91-XXXXXX" : "+९१-XXXXXX",
      icon: FaHeartbeat,
    ...
    },
    {
      ...
      description:
        language === "en" ? "Gram Revenue Officer" : "ग्राम महसूल अधिकारी",
      head: language === "en" ? "Pratik Bhagre" : "प्रतीक भग्रे",
      phone: language === "en" ? "+91-9665389868" : "+९१-९६६५३८९८६८",
      icon: FaLandmark,
      color: "from-yellow-400 to-yellow-600",
    },
    {
      nameKey: "dept.electricity",
      name: language === "en" ? "Electricity Department" : "महावितरण विभाग",
      description:
        language === "en" ? "Power Supply (Wireman)" : "वीज पुरवठा (वायरमन)",
      head: language === "en" ? "Sampat Kadam" : "संपत कदम",
      phone: language === "en" ? "+91-8329726676" : "+९१-८३२९७२६६७६",
      icon: FaBolt,
      color: "from-blue-400 to-blue-600",
    },
    {
      nameKey: "dept.crp",
      name: language === "en" ? "CRP Department" : "सीआरपी विभाग",
      description:
        language === "en"
          ? "Women Savings and Empowerment"
          : "महिला बचत सक्षमीकरण",
      head: language === "en" ? "Bharti Bhagwan More" : "भारती भगवान मोरे",
      phone: language === "en" ? "Not Provided" : "उपलब्ध नाही",
      icon: FaUsers,
